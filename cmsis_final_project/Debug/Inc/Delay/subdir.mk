...
Inc/Delay/%.o Inc/Delay/%.su Inc/Delay/%.cyclo: ../Inc/Delay/%.c Inc/Delay/subdir.mk
...
clean: clean-Inc-2f-Delay

clean-Inc-2f-Delay:
	-$(RM) ./Inc/Delay/delay.cyclo ./Inc/Delay/delay.d ./Inc/Delay/delay.o ./Inc/Delay/delay.su

.PHONY: clean-Inc-2f-Delay
