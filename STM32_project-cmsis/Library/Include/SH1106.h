...
/* I2C address in 7-bit form for the bare-metal driver */
#ifndef SH1106_I2C_ADDR
#define SH1106_I2C_ADDR         0x3C
#endif

/* SH1106 settings */
/* Visible area usually starts at RAM column 2 on 1.3" modules */
#ifndef SH1106_X_OFFSET
#define SH1106_X_OFFSET         1
#endif
...
/**
 * @brief  Bind the SH1106 driver to an I2C peripheral
 * @param  I2C: I2C peripheral (I2C1, I2C2, or I2C3)
 * @retval None
 */
//void SH1106_BindI2C(I2C_TypeDef *I2C);
